...
from gcn.preprocess import eliminate_self_loops as eliminate_self_loops_adj, largest_connected_components


class SparseGraph:
    """
    ----------------------------------------------------------------------
    construct the sparse graph
    ----------------------------------------------------------------------
    """
...
def load_dataset(data_path):
    ...
    """
    ----------------------------------------------------------------------
    load the dataset using the api given in gnn benchmark
    ----------------------------------------------------------------------
    """
...
def load_npz_to_sparse_graph(file_name):
    ...
    """
    ----------------------------------------------------------------------
    make the npz file into sparse graph
    ----------------------------------------------------------------------
    """
